...
|---|---|---|---|---|
| 2026-09-12 | Mentor / handwritten review | "How can workload be calculated?" The dashboard needs to make clear that load comes from tasks. | Connected Dashboard load to actual tasks through shared workload logic. | Judges can see the score has a reason, not just a decorative percentage. |
| 2026-09-12 | Mentor / handwritten review | Dashboard should be one of the remaining core features. | Kept Dashboard as the first warning screen. | It gives users the fastest answer: how heavy is this week? |
| 2026-09-12 | Mentor / handwritten review | Balance should be for when the user is really overloaded. | Balance became a week-based overload repair flow. | It prevents Balance from feeling like random task management. |
| 2026-09-12 | Mentor / handwritten review | Care should be for when the user feels really stressed and needs help managing it. | Recovery, Reflect, and Boundary were grouped under Care. | Emotional support is separated from task balancing, so the app is easier to understand. |
| 2026-09-12 | Mentor / handwritten review | Recovery should let users pick one reset. | Added small recovery tools such as breathing, wooden fish tapping, and bubble popping. | Recovery becomes an immediate action, not generic advice. |
| 2026-09-12 | Mentor / handwritten review | Reflect should help users revise/reflect when pressure is unclear. | Reflect asks one small question based on the stress reason. | Users can understand whether they need rest, a boundary, or schedule changes. |
| 2026-09-12 | Mentor / handwritten review | Boundary should help users who do not know how to reject someone. | Boundary lets users describe the situation and generate soft, firm, or short replies. | Saying no becomes part of workload protection. |
| 2026-09-12 | Mentor / handwritten review | The app had too many pages and too many priorities. | Reduced feature emphasis and grouped care tools together. | The demo flow is clearer: Tasks -> Dashboard -> What-if -> Balance -> Care. |
